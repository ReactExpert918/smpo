...
<link rel="stylesheet"  href="https://fonts.googleapis.com/css?family=<?php echo $font?>">
        ...
        <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-608ebfd3e4445ad3"></script>
      ...
      src: url('https://kareem.tarana.sa/test/fonts/ge-ss-two-bold.ttf');  
