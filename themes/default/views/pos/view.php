                                ...
                                <table class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
											...
											<th class="text-center" style="width: 24%; border-bottom: 2px solid #ddd;"><?=lang('tax');?></th>
                                    ...
                                    <tbody>
                                        ...
                                        $tax_summary = array();
                                        foreach ($rows as $row) {
                                            echo '<tr><th>' . $row->product_name .'</th>';
                                            echo '<td style="text-align:center;">' . $this->tec->formatQuantity($row->quantity) . '</td>';
                                            echo '<td class="text-center">';
                                            echo $this->tec->formatMoney($row->net_unit_price) . '</td><td class="text-center">' . $this->tec->formatMoney($row->item_tax / $row->quantity) . '</td><td class="text-right">' . $this->tec->formatMoney($row->subtotal) . '</td></tr>';
                                        }
                                        ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="3" class="text-right"><?= $this->tec->formatMoney($inv->total - $inv->item_tax_tax); ?></th>
                                        </tr>
                                        <?php
                                        if ($inv->order_tax != 0) {
                                            echo '<tr><th colspan="3">' . lang("order_tax") . '</th><th colspan="2" class="text-right">' . $this->tec->formatMoney($inv->order_tax) . '</th></tr>';
                                        }
                                        if ($inv->total_discount != 0) {
                                            echo '<tr><th colspan="3">' . lang("order_discount") . '</th><th colspan="2" class="text-right">' . $this->tec->formatMoney($inv->total_discount) . '</th></tr>';
                                        }
                                        ...
                                        if ($Settings->rounding) {
                                            ...
                                            ?>
                                            <tr>
                                                <th colspan="3"><?= lang("total_tax"); ?></th>
                                                <th colspan="3" class="text-right"><?= $this->tec->formatMoney($inv->product_tax); ?></th>
                                            </tr>
											<tr>
