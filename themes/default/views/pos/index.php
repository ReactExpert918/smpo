...
<head>
    ...
    <link href="<?= $assets ?>dev/css/custom.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <div id="lefttop" style="margin-bottom:5px;">
                                        <div class="form-group" style="margin-bottom:5px;">
                                            <div class="input-group">
                                                ...
                                                <?= form_dropdown('customer_id', $cus, set_value('customer_id', $Settings->default_customer), 'id="spos_customer" data-placeholder="' . lang("select") . ' ' . lang("customer") . '" required="required" class="form-control select2" onchange="showUser(this.value)" style="width:100%;position:absolute;"'); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button class="btn bg-purple btn-lg btn-block" style="cursor:default;">
                                                    <strong id="number"><?= $this->tec->formatMoney($total_sale->number, 0); ?></strong>
                                                </button>
                                            </div>
                                            <div class="col-md-6">
                                                <button class="btn btn-primary btn-lg btn-block" style="cursor:default;">
                                                    <strong id="amount"><?= $this->tec->formatMoney($total_sale->amount); ?></strong>
                                                </button>
                                            </div>
                                            <div class="col-md-6">
                                                <button class="btn btn-success btn-lg btn-block" style="cursor:default;">
                                                    <strong id="paid"><?= $this->tec->formatMoney($total_sale->paid); ?></strong>
                                                </button>
                                            </div>
                                            <div class="col-md-6">
                                                <button class="btn btn-warning btn-lg btn-block" style="cursor:default;">
                                                    <strong id="due"><?= $this->tec->formatMoney($total_sale->amount-$total_sales->paid); ?></strong>
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <select id="paid_by" class="form-control paid_by select2" style="width:100%;">
                                        ...
                                        <option value="Mada"><?= lang("other"); ?></option>
                        ...
                        function showUser(val) {
                            ...
                            xmlhttp.onreadystatechange = function() {
                                if (this.readyState == 4 && this.status == 200) {
                                    ...
                                    document.getElementById("amount").innerHTML = formatMoney(parse["amount"], 0) + ' amount';
